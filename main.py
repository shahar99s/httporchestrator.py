...
from fetchers.fetcher_registry import create_fetcher, detect_provider

from browserforge.headers import HeaderGenerator

"""
TODO:
- Test mediafire user login, save file to the user files and then download it, this will allow to bypass the downloads counter
