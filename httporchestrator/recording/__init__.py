...
from httporchestrator.recording.models import (
    RequestData,
...
class ExchangeRecorder:
    def capture(
        self, response: httpx.Response, log_details: bool = True
    ) -> RequestResponseRecord:
...
def capture_http_exchange(
    response: httpx.Response, log_details: bool = True
) -> RequestResponseRecord:
